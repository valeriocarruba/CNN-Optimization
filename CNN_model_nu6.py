...
filename_train = '../../IMAGES/nu6_status_all'
Images_loc_train = '../../IMAGES/fig_res_'
names_train = ['id', 'a', 'e', 'sin_i', 'Mag','pred','label']
set_type = 'training'
...
filename_test = 'nu6_status'
Images_loc_test = './fig_res_'
names_test = ['id', 'a', 'e', 'sin_i', 'Mag', 'pred','label']
set_type = 'testing'

test_images, test_labels, test_data, test_id = read_data(filename_test,Images_loc_test, names_test, set_type)

filename_val = '../VALIDATION/nu6_validation_all'
Images_loc_val = '../VALIDATION/fig_res_'
names_val = ['id', 'a', 'e', 'sin_i', 'Mag','pred','label']
set_type = 'validation'
...
def summarize_diagnostics(x):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.title('Cross Entropy Loss: VGG+DA+DO')
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.title('Classification Accuracy: VGG+DA+DO')
    #plt.show()
    plt.tight_layout()
    fig.savefig('history_model_VGG_DA_DO.png', format='png', dpi=300)
    plt.close(fig)
